    ...
    <AuthLayout>
      {hostPending ? (
        <div className="text-center py-2">
          ...
          <h1 className="text-xl font-bold text-main-text mb-2">Registration Submitted!</h1>
          ...
          <button
            ...
            className="w-full py-3 bg-primary text-white text-sm font-semibold rounded-xl hover:bg-primary-hover active:scale-[0.98] transition-all duration-200 shadow-lg shadow-primary/25"
          >
            Back to Login
          </button>
        </div>
        ...
        <>
          ...
          <h1 className="text-[1.65rem] font-bold text-center mb-1.5 text-main-text">Create your account</h1>
          {step === 1 && (
            ...
            <form onSubmit={handleStep1Submit} className="space-y-3.5">
              <div>
                ...
                <input
                  ...
                  className={`input-field ${fieldErrors.name ? 'border-danger' : ''}`}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-primary text-white rounded-xl font-semibold text-sm hover:bg-primary-hover active:scale-[0.98] transition-all duration-200 shadow-lg shadow-primary/25 hover:shadow-primary/40 mt-3"
              >
            ...
            <form onSubmit={handleStep2Submit} className="space-y-3.5">
              ...
              <div>
                ...
                <input
                  ...
                  className={`input-field ${fieldErrors.phone ? 'border-danger' : ''}`}
              ...
              <div className="flex gap-3 mt-4">
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="flex-1 py-3 bg-gray-100 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-200 active:scale-[0.98] transition-all duration-200"
                >
                  Back
                </button>
                <button
                  ...
                  className="flex-1 py-3 bg-primary text-white rounded-xl font-semibold text-sm hover:bg-primary-hover active:scale-[0.98] transition-all duration-200 shadow-lg shadow-primary/25 hover:shadow-primary/40"
                >
                  {loading ? 'Creating...' : phoneChecking ? 'Checking...' : 'Register'}
                </button>
              </div>
            </form>
          )}
